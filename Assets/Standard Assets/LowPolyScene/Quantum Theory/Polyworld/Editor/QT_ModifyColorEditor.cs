...
public class QT_ModifyColorEditor : Editor {
    ...
    public void WriteData()
    {
        ...
        string prefabpathFull = AssetDatabase.GetAssetPath(PrefabUtility.GetCorrespondingObjectFromSource(activeGO));
        ...
        if (fullPath.Length > 0 && fullPath.Contains("Assets"))
        {
           ...
           // MC.tempMesh.colors = tempalpha;
            ...
            GameObject WorkingGO = (GameObject)PrefabUtility.InstantiatePrefab((GameObject)PrefabUtility.GetCorrespondingObjectFromSource(activeRootGO));
            ...
            if (MC.Replace)
            {
                ...
                PrefabUtility.ReplacePrefab(WorkingGO, (GameObject)PrefabUtility.GetCorrespondingObjectFromSource(activeRootGO), ReplacePrefabOptions.ReplaceNameBased);//(GameObject)PrefabUtility.GetPrefabParent((GameObject)this.transform.root.gameObject), ReplacePrefabOptions.ConnectToPrefab);                
            }
